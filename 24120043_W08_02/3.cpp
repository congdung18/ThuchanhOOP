...
public:
    ...
    bool coXuatSac() override;
};

bool NhanVienThuKy::coXuatSac()
{
    return _baoCao >= 12;
}
...
bool NhanVienKyThuat::coXuatSac()
{
    return _sangKien >= 6;
}
...
{
    os << "--- Danh sach nhan vien ---\n";
    for (int i = 0; i < ct._nv.size(); i++)
    {
        os << i + 1 << ": " << *ct._nv[i] << "\n";
    }
